...
const Programs = () => {
  ...
  const renderCharts = () => {
    if (selectedYear && showCharts) {
      ...
      return (
        <div className="charts-container" style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'center', gap: '20px' }}>
          {/* Chart wrapper with shadow and title */}
          <div className="chart-wrapper" style={{ width: '45%', boxShadow: '0px 0px 10px #ccc', padding: '10px', margin: '10px' }}>
            <h2 style={{ textAlign: 'center' }}>School Wise Intake</h2>
          ...
          <div className="chart-wrapper" style={{ width: '45%', boxShadow: '0px 0px 10px #ccc', padding: '10px', margin: '10px' }}>
            <h2 style={{ textAlign: 'center' }}>Program Wise Intake</h2>
            <ResponsiveContainer width="100%" height={300}>
          ...
          <div className="chart-wrapper" style={{ width: '90%', boxShadow: '0px 0px 10px #ccc', padding: '10px', margin: '10px' }}>
            <h2 style={{ textAlign: 'center' }}>Programs Distribution</h2>
            <ResponsiveContainer width="100%" height={300}>
            <PieChart>
                <Pie
